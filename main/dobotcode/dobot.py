...
from dobotcode.message import Message
from dobotcode.ptpMode import PTPMode
from dobotcode.ControlValues import ControlValues
from dobotcode.CommunicationProtocolIDs import CommunicationProtocolIDs
...
class Dobot:
    ...
    def __init__(self, port, verbose=False):
        ...
        # velocity of (x, y, z, r) + acceleration of (x, y, z, r)
    ...
    # queues a translation in dobot to given coordinates
    ...
    # changes velocity and acceleration at which the dobot moves to future coordinates
    ...
    # adds a waiting period to the internal queue of messages
    def wait(self, ms):
        self._set_wait_cmd(ms)

    # Returns the current pose of dobot, as a tuple (x, y, z, r, j1, j2, j3, j4)
    def pose(self):
