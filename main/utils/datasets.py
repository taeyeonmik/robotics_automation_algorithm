...
from main.utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments, clean_str
from main.utils.torch_utils import torch_distributed_zero_first
...
class LoadStreams:  # multiple IP or RTSP cameras
    ...
    def __next__(self):
        ...
        # (modifié) Rotate image : le caméra sur la machine est attaché de manière inverse.
        for idx, im in enumerate(img0):
            img0[idx] = cv2.rotate(im, cv2.ROTATE_180)
...
def letterbox(img, new_shape=(640, 640), color=(114, 114, 114), auto=True, scaleFill=False, scaleup=True, stride=32):
    ...
    assert img.shape[:2], "Le plaie non claire. Essayez une fois de plus."
